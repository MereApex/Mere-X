...
const KEYWORDS = {
  ...
  markup: new Set(["import", "from", "export", "const", "let", "var", "function", "return", "class", "div", "span", "html", "body", "head", "script", "style", "section", "main", "header", "footer", "nav", "button", "input", "form", "template", "slot"])
};
...
const normalise = (language) => {
  ...
  if (["css", "scss", "less", "html", "xml", "svg", "vue", "svelte"].includes(l)) return "markup";
  return "js";
};
