...
const FAQ_ITEMS = [
  ...
  { q: "Which model should I use?", a: "<p>Orion 3 in High for most work. Drop to Nyx 2 in Fast for mechanical edits and quick questions, and rise to Apex 4 with Extra High for a refactor that spans many files or a bug nobody has managed to reproduce.</p>" },
...
export default {
  title: "Mere Code",
  description: "The coding agent that works on your project in the browser. Open a folder, describe the change, review the diff. Powered by Mere Apex 4, Orion 3 and Nyx 2.",
