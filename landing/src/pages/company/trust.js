...
const DATA_FACTS = [
  { q: "Is my data used to train models?", a: "No. API inputs and outputs are never used to train Mere X models. Consumer workspace conversations are excluded by default; contributing them is opt-in and revocable." },
