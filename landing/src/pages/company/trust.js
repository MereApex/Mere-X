...
const DATA_FACTS = [
  { q: "Is my data used to train models?", a: "No. What you send to Mere Studio is never used to train Mere X models. Mere Studio conversations are excluded by default; contributing them is opt-in and revocable." },
  ...
  { q: "Can I delete it?", a: "Yes, from Settings → Data controls, immediately and permanently. Deletion propagates to backups within 30 days." }
];
