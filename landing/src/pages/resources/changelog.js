...
const AREAS = ["All", "API", "Models", "SDKs", "Console", "Mere X 5.5", "Voice"];
      ...
      <section class="section section-line">
        <div class="shell shell-wide">
          ...
          <div style="margin-top:22px;max-width:76ch">
            ${calloutBox("A pinned snapshot ID never changes behaviour. If you are on <code class=\"inline\">mere-apex-5-5-20260618</code>, that model behaves identically until its retirement date — we do not silently update what a pinned ID points at.", { icon: "lock" }).value}
          </div>
        </div>
      </section>
