...
const NOTES = [
  ...
  { q: "Where does Mere Studio still lose?", a: "<p>Several places, and we would rather say so. Symbolic integration beyond undergraduate level; multi-hop spatial reasoning over floor plans; sustained consistency in fiction past roughly 40,000 words; and any task requiring genuinely current information without a search tool attached. The system card enumerates these with examples.</p>" },
