...
const FAQ_ITEMS = [
  ...
  { q: "What happens when alignment work conflicts with capability work?", a: "<p>The release gate is held by the safety organisation. Mere Studio slipped six weeks over a red-team finding on tool-use chains — that is the mechanism working, and we document it rather than quietly absorbing the delay.</p>" },
      ...
      <section class="section section-line">
        <div class="shell shell-wide">
          ${sectionHead({
            ...
            lead: "These figures come from the Mere Studio system card and are re-run on every release.",
